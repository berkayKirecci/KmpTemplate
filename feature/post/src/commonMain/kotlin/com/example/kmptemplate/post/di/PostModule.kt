...
import com.example.kmptemplate.navigation.Navigator
import com.example.kmptemplate.navigation.PostRoute
...
val postModule = module {
    includes(navKeyModule(PostRoute.serializer()))
    ...
    navigation<PostRoute> {
        PostScreen(
            ...
            onNavigateToDetail = { get<Navigator>().navigateTo(DetailRoute) },
        )
    }
}
